...
De repository is opgeschoond. Mappen die overbodig waren zijn vewijderd. De specificatie van de Waardelijsten API is verwijderd omdat die nog niet geïmplementeerd is.
