...
namespace Org.OpenAPITools.Api
{
    ...
    public interface IKadastraalOnroerendeZakenApiSync : IApiAccessor
    {
        ...
        /// <param name="zakelijkgerechtigdeTypegerechtigde">Een typering van het recht dat de zakelijkgerechtigde heeft op de Kadastraal Onroerende Zaak. Door het gebruik van deze query-parameter worden Kadastraal Onroerende Zaken geretourneerd waar een recht op rust van het opgegeven type. (optional)</param>
        /// <param name="adresPostcode">De postcode van het adres van de objectlocatie van de kadastraal onroerende zaak (optional)</param>
        /// <param name="adresHuisnummer">Het huisnummer van het adres van de objectlocatie van de kadastraal onroerende zaak (optional)</param>
        /// <param name="adresHuisletter">De huisletter van het adres van de objectlocatie van de kadastraal onroerende zaak (optional)</param>
        /// <param name="adresHuisnummertoevoeging">De huisnummertoevoeging van het adres van de objectlocatie van de kadastraal onroerende zaak (optional)</param>
        /// <returns>KadastraalOnroerendeZaakHalCollectie</returns>
        KadastraalOnroerendeZaakHalCollectie GetKadastraalOnroerendeZaken (string acceptCrs = default(string), string expand = default(string), string fields = default(string), string kadastraleaanduiding = default(string), string ingeschrevenpersoonBurgerservicenummer = default(string), string persoonKadasterpersoonidentificatie = default(string), TypeGerechtigdeEnum? zakelijkgerechtigdeTypegerechtigde = default(TypeGerechtigdeEnum?), string adresPostcode = default(string), int? adresHuisnummer = default(int?), string adresHuisletter = default(string), string adresHuisnummertoevoeging = default(string));
    ...
    public partial class KadastraalOnroerendeZakenApi : IKadastraalOnroerendeZakenApi
    {
        ...
        {
             Org.OpenAPITools.Client.ApiResponse<KadastraalOnroerendeZaakHal> localVarResponse = await GetKadastraalOnroerendeZaakAsyncWithHttpInfo(kadastraalonroerendezaakidentificatie, acceptCrs, expand, fields);
             return localVarResponse.Data;
        ...
        /// <param name="fields">Hiermee kun je de inhoud van de resource naar behoefte aanpassen door een door komma&#39;s gescheiden lijst van property namen op te geven. Bij opgave van niet-bestaande properties wordt een 400 Bad Request teruggegeven. Wanneer de fields parameter niet is opgegeven, worden alle properties met een waarde teruggegeven. Zie [functionele specificaties](https://github.com/VNG-Realisatie/Haal-Centraal-common/blob/v1.0.0/features/fields.feature) (optional)</param>
        /// <returns>Task of ApiResponse (KadastraalOnroerendeZaakHal)</returns>
        public async System.Threading.Tasks.Task<Org.OpenAPITools.Client.ApiResponse<KadastraalOnroerendeZaakHal>> GetKadastraalOnroerendeZaakAsyncWithHttpInfo (string kadastraalonroerendezaakidentificatie, string acceptCrs = default(string), string expand = default(string), string fields = default(string))
        {
            // verify the required parameter 'kadastraalonroerendezaakidentificatie' is set
            if (kadastraalonroerendezaakidentificatie == null)
                throw new Org.OpenAPITools.Client.ApiException(400, "Missing required parameter 'kadastraalonroerendezaakidentificatie' when calling KadastraalOnroerendeZakenApi->GetKadastraalOnroerendeZaak");
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<KadastraalOnroerendeZaakHal>("/kadastraalonroerendezaken/{kadastraalonroerendezaakidentificatie}", localVarRequestOptions, this.Configuration);
        ...
        public Org.OpenAPITools.Client.ApiResponse< KadastraalOnroerendeZaakHalCollectie > GetKadastraalOnroerendeZakenWithHttpInfo (string acceptCrs = default(string), string expand = default(string), string fields = default(string), string kadastraleaanduiding = default(string), string ingeschrevenpersoonBurgerservicenummer = default(string), string persoonKadasterpersoonidentificatie = default(string), TypeGerechtigdeEnum? zakelijkgerechtigdeTypegerechtigde = default(TypeGerechtigdeEnum?), string adresPostcode = default(string), int? adresHuisnummer = default(int?), string adresHuisletter = default(string), string adresHuisnummertoevoeging = default(string))
        {
            ...
            {
                localVarRequestOptions.QueryParameters.Add(Org.OpenAPITools.Client.ClientUtils.ParameterToMultiMap("", "persoon_kadasterpersoonidentificatie", persoonKadasterpersoonidentificatie));
            }
            if (zakelijkgerechtigdeTypegerechtigde != null)
            {
                localVarRequestOptions.QueryParameters.Add(Org.OpenAPITools.Client.ClientUtils.ParameterToMultiMap("", "zakelijkgerechtigde__typegerechtigde", zakelijkgerechtigdeTypegerechtigde));
            }
            if (adresPostcode != null)
            {
                localVarRequestOptions.QueryParameters.Add(Org.OpenAPITools.Client.ClientUtils.ParameterToMultiMap("", "adres__postcode", adresPostcode));
            }
            if (adresHuisnummer != null)
            {
                localVarRequestOptions.QueryParameters.Add(Org.OpenAPITools.Client.ClientUtils.ParameterToMultiMap("", "adres__huisnummer", adresHuisnummer));
            }
            if (adresHuisletter != null)
            {
                localVarRequestOptions.QueryParameters.Add(Org.OpenAPITools.Client.ClientUtils.ParameterToMultiMap("", "adres__huisletter", adresHuisletter));
            }
            if (adresHuisnummertoevoeging != null)
            {
                localVarRequestOptions.QueryParameters.Add(Org.OpenAPITools.Client.ClientUtils.ParameterToMultiMap("", "adres__huisnummertoevoeging", adresHuisnummertoevoeging));
            }
            if (acceptCrs != null)
            {
                localVarRequestOptions.HeaderParameters.Add("Accept-Crs", Org.OpenAPITools.Client.ClientUtils.ParameterToString(acceptCrs)); // header parameter
        ...
        {
             Org.OpenAPITools.Client.ApiResponse<KadastraalOnroerendeZaakHalCollectie> localVarResponse = await GetKadastraalOnroerendeZakenAsyncWithHttpInfo(acceptCrs, expand, fields, kadastraleaanduiding, ingeschrevenpersoonBurgerservicenummer, persoonKadasterpersoonidentificatie, zakelijkgerechtigdeTypegerechtigde, adresPostcode, adresHuisnummer, adresHuisletter, adresHuisnummertoevoeging);
             return localVarResponse.Data;
        ...
        /// <param name="adresHuisnummertoevoeging">De huisnummertoevoeging van het adres van de objectlocatie van de kadastraal onroerende zaak (optional)</param>
        /// <returns>Task of ApiResponse (KadastraalOnroerendeZaakHalCollectie)</returns>
        public async System.Threading.Tasks.Task<Org.OpenAPITools.Client.ApiResponse<KadastraalOnroerendeZaakHalCollectie>> GetKadastraalOnroerendeZakenAsyncWithHttpInfo (string acceptCrs = default(string), string expand = default(string), string fields = default(string), string kadastraleaanduiding = default(string), string ingeschrevenpersoonBurgerservicenummer = default(string), string persoonKadasterpersoonidentificatie = default(string), TypeGerechtigdeEnum? zakelijkgerechtigdeTypegerechtigde = default(TypeGerechtigdeEnum?), string adresPostcode = default(string), int? adresHuisnummer = default(int?), string adresHuisletter = default(string), string adresHuisnummertoevoeging = default(string))
        {
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<KadastraalOnroerendeZaakHalCollectie>("/kadastraalonroerendezaken", localVarRequestOptions, this.Configuration);
