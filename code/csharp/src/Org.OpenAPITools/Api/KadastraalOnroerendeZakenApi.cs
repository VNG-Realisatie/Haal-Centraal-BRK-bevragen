...
namespace Org.OpenAPITools.Api
{
    ...
    public partial class KadastraalOnroerendeZakenApi : IKadastraalOnroerendeZakenApi
    {
        ...
        public ApiResponse<KadastraalOnroerendeZaakHalCollectie> GetKadastraalOnroerendeZakenWithHttpInfo (string acceptCrs = default(string), string expand = default(string), string fields = default(string), string kadastraleaanduiding = default(string), string ingeschrevenpersoonBurgerservicenummer = default(string), string persoonKadasterpersoonidentificatie = default(string), TypeGerechtigdeEnum? zakelijkgerechtigdeTypegerechtigde = default(TypeGerechtigdeEnum?), string adresPostcode = default(string), int? adresHuisnummer = default(int?), string adresHuisletter = default(string), string adresHuisnummertoevoeging = default(string))
        {
            ...
            if (ingeschrevenpersoonBurgerservicenummer != null) localVarQueryParams.AddRange(this.Configuration.ApiClient.ParameterToKeyValuePairs("", "ingeschrevenpersoon__burgerservicenummer", ingeschrevenpersoonBurgerservicenummer)); // query parameter
            if (persoonKadasterpersoonidentificatie != null) localVarQueryParams.AddRange(this.Configuration.ApiClient.ParameterToKeyValuePairs("", "persoon_kadasterpersoonidentificatie", persoonKadasterpersoonidentificatie)); // query parameter
            if (zakelijkgerechtigdeTypegerechtigde != null) localVarQueryParams.AddRange(this.Configuration.ApiClient.ParameterToKeyValuePairs("", "zakelijkgerechtigde__typegerechtigde", zakelijkgerechtigdeTypegerechtigde)); // query parameter
            if (adresPostcode != null) localVarQueryParams.AddRange(this.Configuration.ApiClient.ParameterToKeyValuePairs("", "adres__postcode", adresPostcode)); // query parameter
            if (adresHuisnummer != null) localVarQueryParams.AddRange(this.Configuration.ApiClient.ParameterToKeyValuePairs("", "adres__huisnummer", adresHuisnummer)); // query parameter
            if (adresHuisletter != null) localVarQueryParams.AddRange(this.Configuration.ApiClient.ParameterToKeyValuePairs("", "adres__huisletter", adresHuisletter)); // query parameter
            if (adresHuisnummertoevoeging != null) localVarQueryParams.AddRange(this.Configuration.ApiClient.ParameterToKeyValuePairs("", "adres__huisnummertoevoeging", adresHuisnummertoevoeging)); // query parameter
            if (acceptCrs != null) localVarHeaderParams.Add("Accept-Crs", this.Configuration.ApiClient.ParameterToString(acceptCrs)); // header parameter
        ...
        {
             ApiResponse<KadastraalOnroerendeZaakHalCollectie> localVarResponse = await GetKadastraalOnroerendeZakenAsyncWithHttpInfo(acceptCrs, expand, fields, kadastraleaanduiding, ingeschrevenpersoonBurgerservicenummer, persoonKadasterpersoonidentificatie, zakelijkgerechtigdeTypegerechtigde, adresPostcode, adresHuisnummer, adresHuisletter, adresHuisnummertoevoeging);
             return localVarResponse.Data;
