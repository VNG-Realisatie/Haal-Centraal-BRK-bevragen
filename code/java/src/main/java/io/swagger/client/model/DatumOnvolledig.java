 ...
 */
@Schema(description = "Gegevens over de datums die mogelijk niet volledig zijn, maar waarvan de bekende gedeeltes wel moeten kunnen worden uitgewisseld. Als de volledige datum bekend is worden alle elementen gevuld.")
...
public class DatumOnvolledig {
   ...
   * @return dag
  **/
  @Schema(example = "3", description = "De dag. Als de dag van de datum bekend is wordt deze hier ingevuld. Ook als de volledige datum bekend is.")
   ...
   * @return datum
  **/
  @Schema(example = "Wed May 03 02:00:00 CEST 1989", description = "De volledige datum die in de `date` definitie past. Dit element wordt alleen gevuld als de volledige datum bekend is.")
   ...
   * @return jaar
  **/
  @Schema(example = "1989", description = "Het jaar van de datum. Als het jaar bekend is wordt dit element gevuld, ook als de volledige datum bekend is.")
   ...
   * @return maand
  **/
  @Schema(example = "5", description = "De maand. Als de maand van een datum bekend is wordt deze hier ingevuld. Ook als de volledige datum is ingevuld.")
