...
public class ApiClient {
    ...
    private String basePath = "https://api.brk.kadaster.nl/esd-eto-apikey/bevragen/v1";
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.brk.kadaster.nl/esd-eto-apikey/bevragen/v1
