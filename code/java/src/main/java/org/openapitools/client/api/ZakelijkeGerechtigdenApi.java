...
public class ZakelijkeGerechtigdenApi {
     ...
     */
    public okhttp3.Call getZakelijkGerechtigdeCall(String kadastraalonroerendezaakidentificatie, String zakelijkgerechtigdeidentificatie, String fields, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call getZakelijkGerechtigdeValidateBeforeCall(String kadastraalonroerendezaakidentificatie, String zakelijkgerechtigdeidentificatie, String fields, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getZakelijkGerechtigdeCall(kadastraalonroerendezaakidentificatie, zakelijkgerechtigdeidentificatie, fields, _callback);
        return localVarCall;
    ...
    public ZakelijkGerechtigdeHal getZakelijkGerechtigde(String kadastraalonroerendezaakidentificatie, String zakelijkgerechtigdeidentificatie, String fields) throws ApiException {
        ApiResponse<ZakelijkGerechtigdeHal> localVarResp = getZakelijkGerechtigdeWithHttpInfo(kadastraalonroerendezaakidentificatie, zakelijkgerechtigdeidentificatie, fields);
    ...
    public ApiResponse<ZakelijkGerechtigdeHal> getZakelijkGerechtigdeWithHttpInfo(String kadastraalonroerendezaakidentificatie, String zakelijkgerechtigdeidentificatie, String fields) throws ApiException {
        okhttp3.Call localVarCall = getZakelijkGerechtigdeValidateBeforeCall(kadastraalonroerendezaakidentificatie, zakelijkgerechtigdeidentificatie, fields, null);
     ...
     */
    public okhttp3.Call getZakelijkGerechtigdeAsync(String kadastraalonroerendezaakidentificatie, String zakelijkgerechtigdeidentificatie, String fields, final ApiCallback<ZakelijkGerechtigdeHal> _callback) throws ApiException {

        okhttp3.Call localVarCall = getZakelijkGerechtigdeValidateBeforeCall(kadastraalonroerendezaakidentificatie, zakelijkgerechtigdeidentificatie, fields, _callback);
        Type localVarReturnType = new TypeToken<ZakelijkGerechtigdeHal>(){}.getType();
     ...
     */
    public okhttp3.Call getZakelijkGerechtigdenCall(String kadastraalonroerendezaakidentificatie, String fields, TypeGerechtigdeEnum type, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getZakelijkGerechtigdenValidateBeforeCall(String kadastraalonroerendezaakidentificatie, String fields, TypeGerechtigdeEnum type, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getZakelijkGerechtigdenCall(kadastraalonroerendezaakidentificatie, fields, type, _callback);
        return localVarCall;
     ...
     */
    public ZakelijkGerechtigdeHalCollectie getZakelijkGerechtigden(String kadastraalonroerendezaakidentificatie, String fields, TypeGerechtigdeEnum type) throws ApiException {
        ApiResponse<ZakelijkGerechtigdeHalCollectie> localVarResp = getZakelijkGerechtigdenWithHttpInfo(kadastraalonroerendezaakidentificatie, fields, type);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<ZakelijkGerechtigdeHalCollectie> getZakelijkGerechtigdenWithHttpInfo(String kadastraalonroerendezaakidentificatie, String fields, TypeGerechtigdeEnum type) throws ApiException {
        okhttp3.Call localVarCall = getZakelijkGerechtigdenValidateBeforeCall(kadastraalonroerendezaakidentificatie, fields, type, null);
     ...
     */
    public okhttp3.Call getZakelijkGerechtigdenAsync(String kadastraalonroerendezaakidentificatie, String fields, TypeGerechtigdeEnum type, final ApiCallback<ZakelijkGerechtigdeHalCollectie> _callback) throws ApiException {

        okhttp3.Call localVarCall = getZakelijkGerechtigdenValidateBeforeCall(kadastraalonroerendezaakidentificatie, fields, type, _callback);
        Type localVarReturnType = new TypeToken<ZakelijkGerechtigdeHalCollectie>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
