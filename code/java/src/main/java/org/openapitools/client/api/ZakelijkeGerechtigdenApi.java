...
public class ZakelijkeGerechtigdenApi {
     ...
     */
    public okhttp3.Call getZakelijkGerechtigdenCall(String kadastraalonroerendezaakidentificatie, String fields, TypeGerechtigdeEnum typegerechtigde, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
        ...
        if (typegerechtigde != null) {
            localVarQueryParams.addAll(localVarApiClient.parameterToPair("typegerechtigde", typegerechtigde));
        }
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getZakelijkGerechtigdenValidateBeforeCall(String kadastraalonroerendezaakidentificatie, String fields, TypeGerechtigdeEnum typegerechtigde, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getZakelijkGerechtigdenCall(kadastraalonroerendezaakidentificatie, fields, typegerechtigde, _callback);
        return localVarCall;
    ...
    public ZakelijkGerechtigdeHalCollectie getZakelijkGerechtigden(String kadastraalonroerendezaakidentificatie, String fields, TypeGerechtigdeEnum typegerechtigde) throws ApiException {
        ApiResponse<ZakelijkGerechtigdeHalCollectie> localVarResp = getZakelijkGerechtigdenWithHttpInfo(kadastraalonroerendezaakidentificatie, fields, typegerechtigde);
        return localVarResp.getData();
    }
    ...
    public ApiResponse<ZakelijkGerechtigdeHalCollectie> getZakelijkGerechtigdenWithHttpInfo(String kadastraalonroerendezaakidentificatie, String fields, TypeGerechtigdeEnum typegerechtigde) throws ApiException {
        okhttp3.Call localVarCall = getZakelijkGerechtigdenValidateBeforeCall(kadastraalonroerendezaakidentificatie, fields, typegerechtigde, null);
     ...
     */
    public okhttp3.Call getZakelijkGerechtigdenAsync(String kadastraalonroerendezaakidentificatie, String fields, TypeGerechtigdeEnum typegerechtigde, final ApiCallback<ZakelijkGerechtigdeHalCollectie> _callback) throws ApiException {

        okhttp3.Call localVarCall = getZakelijkGerechtigdenValidateBeforeCall(kadastraalonroerendezaakidentificatie, fields, typegerechtigde, _callback);
        Type localVarReturnType = new TypeToken<ZakelijkGerechtigdeHalCollectie>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
