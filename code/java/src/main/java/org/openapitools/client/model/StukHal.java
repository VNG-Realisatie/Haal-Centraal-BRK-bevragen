...
public class StukHal {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(identificatie, stukType, domein, toelichtingBewaarder, stukdeelIdentificaties, bewaardersVerklaring, indicatieTekeningBijgevoegd, tijdstipAanbieding, tijdstipOndertekening, aard, status, equivalentieVerklaarder, kadasterverzoeken, links, embedded);
  }
