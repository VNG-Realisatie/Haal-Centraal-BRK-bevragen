...
namespace Org.OpenAPITools.Api
{
    ...
    public partial class HypothekenApi : IHypothekenApi
    {
        ...
        {
             ApiResponse<HypotheekHal> localVarResponse = GetHypotheekWithHttpInfo(kadastraalonroerendezaakidentificatie, hypotheekidentificatie, fields, acceptCrs);
        ...
        /// <param name="acceptCrs">Gewenste CRS van de coördinaten in de response. (optional)</param>
        /// <returns>ApiResponse of HypotheekHal</returns>
        public ApiResponse<HypotheekHal> GetHypotheekWithHttpInfo (string kadastraalonroerendezaakidentificatie, string hypotheekidentificatie, string fields = default(string), string acceptCrs = default(string))
        {
        ...
        {
             ApiResponse<HypotheekHalCollectie> localVarResponse = GetHypothekenKadastraalOnroerendeZaakWithHttpInfo(kadastraalonroerendezaakidentificatie, fields, acceptCrs);
             return localVarResponse.Data;
        }
        ...
        /// <param name="acceptCrs">Gewenste CRS van de coördinaten in de response. (optional)</param>
        /// <returns>ApiResponse of HypotheekHalCollectie</returns>
        public ApiResponse<HypotheekHalCollectie> GetHypothekenKadastraalOnroerendeZaakWithHttpInfo (string kadastraalonroerendezaakidentificatie, string fields = default(string), string acceptCrs = default(string))
        {
            // verify the required parameter 'kadastraalonroerendezaakidentificatie' is set
            if (kadastraalonroerendezaakidentificatie == null)
