...
namespace Org.OpenAPITools.Api
{
    ...
    public interface IKadastraalOnroerendeZakenApi : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<KadastraalOnroerendeZaakHalCollectie> GetKadastraalOnroerendeZakenAsync (string acceptCrs = default(string), string expand = default(string), string fields = default(string), string kadastraleAanduiding = default(string), string burgerservicenummer = default(string), string persoonIdentificatie = default(string), TypeGerechtigdeEnum? zakelijkGerechtigdeType = default(TypeGerechtigdeEnum?), string postcode = default(string), int? huisnummer = default(int?), string huisletter = default(string), string huisnummertoevoeging = default(string), string nummeraanduidingIdentificatie = default(string), string kadastraleAanduidingMetGemeentecode = default(string), CancellationToken cancellationToken = default(CancellationToken));
    ...
    public partial class KadastraalOnroerendeZakenApi : IKadastraalOnroerendeZakenApi
    {
        ...
        public ApiResponse<KadastraalOnroerendeZaakHalCollectie> GetKadastraalOnroerendeZakenWithHttpInfo (string acceptCrs = default(string), string expand = default(string), string fields = default(string), string kadastraleAanduiding = default(string), string burgerservicenummer = default(string), string persoonIdentificatie = default(string), TypeGerechtigdeEnum? zakelijkGerechtigdeType = default(TypeGerechtigdeEnum?), string postcode = default(string), int? huisnummer = default(int?), string huisletter = default(string), string huisnummertoevoeging = default(string), string nummeraanduidingIdentificatie = default(string), string kadastraleAanduidingMetGemeentecode = default(string))
        {
            ...
            if (kadastraleAanduidingMetGemeentecode != null) localVarQueryParams.AddRange(this.Configuration.ApiClient.ParameterToKeyValuePairs("", "kadastraleAanduidingMetGemeentecode", kadastraleAanduidingMetGemeentecode)); // query parameter
            if (acceptCrs != null) localVarHeaderParams.Add("Accept-Crs", this.Configuration.ApiClient.ParameterToString(acceptCrs)); // header parameter
        ...
        {
             ApiResponse<KadastraalOnroerendeZaakHalCollectie> localVarResponse = await GetKadastraalOnroerendeZakenWithHttpInfoAsync(acceptCrs, expand, fields, kadastraleAanduiding, burgerservicenummer, persoonIdentificatie, zakelijkGerechtigdeType, postcode, huisnummer, huisletter, huisnummertoevoeging, nummeraanduidingIdentificatie, kadastraleAanduidingMetGemeentecode, cancellationToken);
             return localVarResponse.Data;
