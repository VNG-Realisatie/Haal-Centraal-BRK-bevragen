...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class AdresUitgebreid :  IEquatable<AdresUitgebreid>, IValidatableObject
    {
        ...
        public AdresUitgebreid(string straat = default(string), int huisnummer = default(int), string huisletter = default(string), string huisnummertoevoeging = default(string), string postcode = default(string), string woonplaats = default(string), string nummeraanduidingIdentificatie = default(string), string adresregel1 = default(string), string adresregel2 = default(string), string adresregel3 = default(string), Waardelijst land = default(Waardelijst))
        {
            this.Straat = straat;
