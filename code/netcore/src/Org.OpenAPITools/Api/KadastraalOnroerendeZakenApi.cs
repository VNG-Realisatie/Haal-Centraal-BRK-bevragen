...
namespace Org.OpenAPITools.Api
{
    ...
    public interface IKadastraalOnroerendeZakenApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<KadastraalOnroerendeZaakHalCollectie> GetKadastraalOnroerendeZakenAsync(string acceptCrs = default(string), string expand = default(string), string fields = default(string), string kadastraleAanduiding = default(string), string burgerservicenummer = default(string), string persoonIdentificatie = default(string), TypeGerechtigdeEnum? zakelijkGerechtigdeType = default(TypeGerechtigdeEnum?), string postcode = default(string), int? huisnummer = default(int?), string huisletter = default(string), string huisnummertoevoeging = default(string), string nummeraanduidingIdentificatie = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class KadastraalOnroerendeZakenApi : IKadastraalOnroerendeZakenApi
    {
        ...
        {
            Org.OpenAPITools.Client.ApiResponse<KadastraalOnroerendeZaakHalCollectie> localVarResponse = GetKadastraalOnroerendeZakenWithHttpInfo(acceptCrs, expand, fields, kadastraleAanduiding, burgerservicenummer, persoonIdentificatie, zakelijkGerechtigdeType, postcode, huisnummer, huisletter, huisnummertoevoeging, nummeraanduidingIdentificatie);
            return localVarResponse.Data;
        }
        ...
        {
            Org.OpenAPITools.Client.ApiResponse<KadastraalOnroerendeZaakHalCollectie> localVarResponse = await GetKadastraalOnroerendeZakenWithHttpInfoAsync(acceptCrs, expand, fields, kadastraleAanduiding, burgerservicenummer, persoonIdentificatie, zakelijkGerechtigdeType, postcode, huisnummer, huisletter, huisnummertoevoeging, nummeraanduidingIdentificatie, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
