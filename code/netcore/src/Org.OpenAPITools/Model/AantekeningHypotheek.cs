...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AantekeningHypotheek")]
    public partial class AantekeningHypotheek : IEquatable<AantekeningHypotheek>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AantekeningHypotheek" /> class.
        /// </summary>
        ...
        public AantekeningHypotheek(Waardelijst aard = default(Waardelijst), string omschrijving = default(string), bool betreftGedeelteVanPerceel = default(bool))
        {
            this.Aard = aard;
        ...
        {
            return this.Equals(input as AantekeningHypotheek);
        }

        /// <summary>
        /// Returns true if AantekeningHypotheek instances are equal
        /// </summary>
        /// <param name="input">Instance of AantekeningHypotheek to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AantekeningHypotheek input)
        {
            if (input == null)
                return false;
