...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AantekeningTenaamstelling")]
    public partial class AantekeningTenaamstelling : IEquatable<AantekeningTenaamstelling>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AantekeningTenaamstelling" /> class.
        /// </summary>
        ...
        public AantekeningTenaamstelling(Waardelijst aard = default(Waardelijst), string omschrijving = default(string), bool betreftGedeelteVanPerceel = default(bool), string identificatie = default(string), string domein = default(string), DateTime einddatum = default(DateTime), DateTime einddatumRecht = default(DateTime), List<string> stukIdentificaties = default(List<string>), string isGebaseerdOpStukdeelIdentificatie = default(string), List<string> isVermeldInStukdeelIdentificaties = default(List<string>), PolygonGeoJSON begrenzing = default(PolygonGeoJSON), bool indicatieOorspronkelijkObject = default(bool))
        {
            this.Aard = aard;
        ...
        {
            return this.Equals(input as AantekeningTenaamstelling);
        }

        /// <summary>
        /// Returns true if AantekeningTenaamstelling instances are equal
        /// </summary>
        /// <param name="input">Instance of AantekeningTenaamstelling to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AantekeningTenaamstelling input)
        {
            if (input == null)
                return false;
