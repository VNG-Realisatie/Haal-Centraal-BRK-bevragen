...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AppartementsrechtLinks")]
    public partial class AppartementsrechtLinks : IEquatable<AppartementsrechtLinks>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AppartementsrechtLinks" /> class.
        /// </summary>
        ...
        public AppartementsrechtLinks(HalLink self = default(HalLink), List<HalLink> zakelijkGerechtigden = default(List<HalLink>), List<HalLink> privaatrechtelijkeBeperkingen = default(List<HalLink>), List<HalLink> hypotheken = default(List<HalLink>), List<HalLink> isOntstaanUit = default(List<HalLink>), List<HalLink> isOvergegaanIn = default(List<HalLink>), List<HalLink> beslagen = default(List<HalLink>), List<HalLink> stukken = default(List<HalLink>), List<HalLink> stukdelen = default(List<HalLink>), List<HalLink> adressen = default(List<HalLink>), List<HalLink> adresseerbareObjecten = default(List<HalLink>), List<HalLink> bijbehorendeGrondpercelen = default(List<HalLink>))
        {
            this.Self = self;
        ...
        {
            return this.Equals(input as AppartementsrechtLinks);
        }

        /// <summary>
        /// Returns true if AppartementsrechtLinks instances are equal
        /// </summary>
        /// <param name="input">Instance of AppartementsrechtLinks to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AppartementsrechtLinks input)
        {
            if (input == null)
                return false;
