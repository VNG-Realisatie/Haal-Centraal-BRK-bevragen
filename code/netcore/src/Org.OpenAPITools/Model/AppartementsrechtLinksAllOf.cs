...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AppartementsrechtLinks_allOf")]
    public partial class AppartementsrechtLinksAllOf : IEquatable<AppartementsrechtLinksAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AppartementsrechtLinksAllOf" /> class.
        /// </summary>
        /// <param name="bijbehorendeGrondpercelen">bijbehorendeGrondpercelen.</param>
        public AppartementsrechtLinksAllOf(List<HalLink> bijbehorendeGrondpercelen = default(List<HalLink>))
        {
        ...
        {
            return this.Equals(input as AppartementsrechtLinksAllOf);
        }

        /// <summary>
        /// Returns true if AppartementsrechtLinksAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of AppartementsrechtLinksAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AppartementsrechtLinksAllOf input)
        {
            if (input == null)
                return false;
