...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class BeslagLinks : IEquatable<BeslagLinks>, IValidatableObject
    {
        ...
        public BeslagLinks(HalLink self = default(HalLink), List<HalLink> beslagleggers = default(List<HalLink>), List<HalLink> stukken = default(List<HalLink>), List<HalLink> stukdelen = default(List<HalLink>))
        {
            this.Self = self;
