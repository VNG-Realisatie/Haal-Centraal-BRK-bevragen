...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class HalLink2 :  IEquatable<HalLink2>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="HalLink2" /> class.
        /// </summary>
        ...
        public HalLink2(string href = default(string), bool templated = default(bool), string title = default(string))
        {
            // to ensure "href" is required (not null)
            this.Href = href ?? throw new ArgumentNullException("href is a required property for HalLink2 and cannot be null");
        ...
        {
            return this.Equals(input as HalLink2);
        }

        /// <summary>
        /// Returns true if HalLink2 instances are equal
        /// </summary>
        /// <param name="input">Instance of HalLink2 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(HalLink2 input)
        {
            if (input == null)
                return false;
