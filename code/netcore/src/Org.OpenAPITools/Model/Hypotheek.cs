...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Hypotheek")]
    public partial class Hypotheek : IEquatable<Hypotheek>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Hypotheek" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as Hypotheek);
        }

        /// <summary>
        /// Returns true if Hypotheek instances are equal
        /// </summary>
        /// <param name="input">Instance of Hypotheek to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Hypotheek input)
        {
            if (input == null)
                return false;
