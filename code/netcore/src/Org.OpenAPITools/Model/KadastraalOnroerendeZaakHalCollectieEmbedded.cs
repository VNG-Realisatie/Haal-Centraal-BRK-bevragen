...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "KadastraalOnroerendeZaakHalCollectieEmbedded")]
    public partial class KadastraalOnroerendeZaakHalCollectieEmbedded : IEquatable<KadastraalOnroerendeZaakHalCollectieEmbedded>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="KadastraalOnroerendeZaakHalCollectieEmbedded" /> class.
        /// </summary>
        /// <param name="kadastraalOnroerendeZaken">kadastraalOnroerendeZaken.</param>
        public KadastraalOnroerendeZaakHalCollectieEmbedded(List<KadastraalOnroerendeZaakHal> kadastraalOnroerendeZaken = default(List<KadastraalOnroerendeZaakHal>))
        {
        ...
        {
            return this.Equals(input as KadastraalOnroerendeZaakHalCollectieEmbedded);
        }

        /// <summary>
        /// Returns true if KadastraalOnroerendeZaakHalCollectieEmbedded instances are equal
        /// </summary>
        /// <param name="input">Instance of KadastraalOnroerendeZaakHalCollectieEmbedded to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(KadastraalOnroerendeZaakHalCollectieEmbedded input)
        {
            if (input == null)
                return false;
