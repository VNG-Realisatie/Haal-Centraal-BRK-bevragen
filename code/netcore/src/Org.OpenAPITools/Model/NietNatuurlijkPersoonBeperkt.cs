...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "NietNatuurlijkPersoonBeperkt")]
    public partial class NietNatuurlijkPersoonBeperkt : IEquatable<NietNatuurlijkPersoonBeperkt>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="NietNatuurlijkPersoonBeperkt" /> class.
        /// </summary>
        ...
        public NietNatuurlijkPersoonBeperkt(string identificatie = default(string), string omschrijving = default(string), NietNatuurlijkPersoonTypeEnum? type = default(NietNatuurlijkPersoonTypeEnum?))
        {
        ...
        {
            return this.Equals(input as NietNatuurlijkPersoonBeperkt);
        }

        /// <summary>
        /// Returns true if NietNatuurlijkPersoonBeperkt instances are equal
        /// </summary>
        /// <param name="input">Instance of NietNatuurlijkPersoonBeperkt to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NietNatuurlijkPersoonBeperkt input)
        {
            if (input == null)
                return false;
