...
namespace Org.OpenAPITools.Model
{
    ...
    /// StukHalBasis
    /// </summary>
    [DataContract(Name = "StukHalBasis")]
    public partial class StukHalBasis : IEquatable<StukHalBasis>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as StukHalBasis);
        }

        /// <summary>
        /// Returns true if StukHalBasis instances are equal
        /// </summary>
        /// <param name="input">Instance of StukHalBasis to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StukHalBasis input)
        {
            if (input == null)
                return false;
