...
namespace Org.OpenAPITools.Model
{
    ...
    /// StukLinks
    /// </summary>
    [DataContract(Name = "StukLinks")]
    public partial class StukLinks : IEquatable<StukLinks>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StukLinks" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as StukLinks);
        }

        /// <summary>
        /// Returns true if StukLinks instances are equal
        /// </summary>
        /// <param name="input">Instance of StukLinks to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StukLinks input)
        {
            if (input == null)
                return false;
