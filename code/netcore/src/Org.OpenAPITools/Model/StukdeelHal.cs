...
namespace Org.OpenAPITools.Model
{
    ...
    /// StukdeelHal
    /// </summary>
    [DataContract(Name = "StukdeelHal")]
    public partial class StukdeelHal : IEquatable<StukdeelHal>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StukdeelHal" /> class.
        /// </summary>
        ...
        public StukdeelHal(string identificatie = default(string), string domein = default(string), Waardelijst aard = default(Waardelijst), Bedrag bedragTransactiesomLevering = default(Bedrag), string omschrijvingKadastraleObjecten = default(string), string omschrijvingTopografischeMutatie = default(string), StukdeelLinks links = default(StukdeelLinks), StukdeelEmbedded embedded = default(StukdeelEmbedded))
        {
        ...
        public StukdeelLinks Links { get; set; }

        /// <summary>
        /// Gets or Sets Embedded
        /// </summary>
        [DataMember(Name = "_embedded", EmitDefaultValue = false)]
        public StukdeelEmbedded Embedded { get; set; }
        ...
        {
            return this.Equals(input as StukdeelHal);
        }

        /// <summary>
        /// Returns true if StukdeelHal instances are equal
        /// </summary>
        /// <param name="input">Instance of StukdeelHal to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StukdeelHal input)
        {
            if (input == null)
                return false;
