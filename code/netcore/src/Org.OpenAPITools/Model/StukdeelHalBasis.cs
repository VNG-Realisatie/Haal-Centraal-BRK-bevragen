...
namespace Org.OpenAPITools.Model
{
    ...
    /// StukdeelHalBasis
    /// </summary>
    [DataContract(Name = "StukdeelHalBasis")]
    public partial class StukdeelHalBasis : IEquatable<StukdeelHalBasis>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as StukdeelHalBasis);
        }

        /// <summary>
        /// Returns true if StukdeelHalBasis instances are equal
        /// </summary>
        /// <param name="input">Instance of StukdeelHalBasis to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StukdeelHalBasis input)
        {
            if (input == null)
                return false;
