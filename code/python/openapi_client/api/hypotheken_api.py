...
class HypothekenApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_hypotheek_endpoint = _Endpoint(
            settings={
            ...
            root_map={
                ...
                'attribute_map': {
                    ...
                    'hypotheek_identificatie': 'hypotheekIdentificatie',
                    'fields': 'fields',
                },
                'location_map': {
                    'kadastraal_onroerende_zaak_identificatie': 'path',
                    'hypotheek_identificatie': 'path',
                    'fields': 'query',
                },
        ...
        self.get_hypotheken_kadastraal_onroerende_zaak_endpoint = _Endpoint(
            settings={
    ...
    def get_hypotheek(
        ...
        **kwargs
        ...
        Raadpleeg een hypotheek die rust op een kadastraal onroerende zaak en bijbehorende hypotheekhouder(s). Een hypotheekhouder vestigt als geldverstrekker een recht van hypotheek als zekerheid voor de lening.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_hypotheek(kadastraal_onroerende_zaak_identificatie, hypotheek_identificatie, async_req=True)
        >>> result = thread.get()

        Args:
            kadastraal_onroerende_zaak_identificatie (str): De unieke identificatie van een kadastraal onroerende zaak. 
            hypotheek_identificatie (str): De unieke identificatie van de hypotheek. 
        ...
        kwargs['kadastraal_onroerende_zaak_identificatie'] = \
            kadastraal_onroerende_zaak_identificatie
        kwargs['hypotheek_identificatie'] = \
            hypotheek_identificatie
        return self.get_hypotheek_endpoint.call_with_http_info(**kwargs)

    def get_hypotheken_kadastraal_onroerende_zaak(
        self,
        kadastraal_onroerende_zaak_identificatie,
        **kwargs
    ):
        ...
        Raadpleeg hypotheken die rusten op een kadastraal onroerende zaak en bijbehorende hypotheekhouder(s). Een hypotheekhouder vestigt als geldverstrekker een recht van hypotheek als zekerheid voor de lening.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_hypotheken_kadastraal_onroerende_zaak(kadastraal_onroerende_zaak_identificatie, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['kadastraal_onroerende_zaak_identificatie'] = \
            kadastraal_onroerende_zaak_identificatie
        return self.get_hypotheken_kadastraal_onroerende_zaak_endpoint.call_with_http_info(**kwargs)
