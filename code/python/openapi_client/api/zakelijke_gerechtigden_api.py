...
class ZakelijkeGerechtigdenApi(object):
    ...
    def get_zakelijk_gerechtigden_with_http_info(self, kadastraalonroerendezaakidentificatie, **kwargs):  # noqa: E501
        ...
        if 'fields' in local_var_params and local_var_params['fields'] is not None:  # noqa: E501
            query_params.append(('fields', local_var_params['fields']))  # noqa: E501
        if 'typegerechtigde' in local_var_params and local_var_params['typegerechtigde'] is not None:  # noqa: E501
            query_params.append(('typegerechtigde', local_var_params['typegerechtigde']))  # noqa: E501
