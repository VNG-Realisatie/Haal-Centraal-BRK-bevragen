...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = BeslagenApi()
        api_instance.get_beslag  # this is an instance of the class Endpoint
        api_instance.get_beslag()  # this invokes api_instance.get_beslag.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get_beslag.callable or self.callable in this class
