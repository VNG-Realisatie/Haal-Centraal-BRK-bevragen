...
def lazy_import():
    ...
    globals()['AppartementsrechtFiliatieAllOf'] = AppartementsrechtFiliatieAllOf
...
class AppartementsrechtFiliatie(ModelComposed):
    ...
    def discriminator():
        lazy_import()
        val = {
            'appartementsrecht': AppartementsrechtFiliatie,
            'perceel': PerceelFiliatie,
        }
        if not val:
            return None
        return {'type': val}
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """AppartementsrechtFiliatie - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            identificatie (str): De identificatie(s) van de Kadastraal Onroerende Za(a)k(en). . [optional]  # noqa: E501
        """
