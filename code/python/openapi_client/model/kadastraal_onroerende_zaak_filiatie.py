...
class KadastraalOnroerendeZaakFiliatie(ModelNormal):
    ...
    def discriminator():
        lazy_import()
        val = {
            'AppartementsrechtFiliatie': AppartementsrechtFiliatie,
            'PerceelFiliatie': PerceelFiliatie,
    ...
    def _from_openapi_data(cls, type, *args, **kwargs):  # noqa: E501
        """KadastraalOnroerendeZaakFiliatie - a model defined in OpenAPI
