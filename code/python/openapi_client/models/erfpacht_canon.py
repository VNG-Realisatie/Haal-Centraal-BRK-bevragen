...
class ErfpachtCanon(object):
    ...
    def __init__(self, soort_erfpacht_canon=None, jaarlijks_bedrag=None, betref_meer_onroerende_zaken=None, einddatum_afkoop=None, indicatie_oude_onroerende_zaak_betrokken=None, local_vars_configuration=None):  # noqa: E501
