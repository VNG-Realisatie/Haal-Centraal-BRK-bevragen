...
class PrivaatrechtelijkeBeperkingHal(object):
    ...
    def __init__(self, aard=None, omschrijving=None, betreft_gedeelte_van_perceel=None, identificatie=None, domein=None, einddatum=None, einddatum_recht=None, links=None, local_vars_configuration=None):  # noqa: E501
