...
class ZakelijkGerechtigde(object):
    ...
    def __init__(self, identificatie=None, type=None, aanvangsdatum=None, erfpacht_canon=None, tenaamstelling=None, persoon=None, local_vars_configuration=None):  # noqa: E501
