...
class Postadres(object):
    ...
    if hasattr(Adres, "swagger_types"):
        swagger_types.update(Adres.swagger_types)
    ...
    if hasattr(Adres, "attribute_map"):
        attribute_map.update(Adres.attribute_map)

    def __init__(self, nummeraanduiding_identificatie=None, huisnummer=None, huisletter=None, huisnummertoevoeging=None, straat=None, postcode=None, woonplaats=None, adresregel1=None, adresregel2=None, adresregel3=None, land=None, postbusnummer=None, *args, **kwargs):  # noqa: E501
        """Postadres - a model defined in Swagger"""  # noqa: E501
        ...
        Adres.__init__(self, *args, **kwargs)
