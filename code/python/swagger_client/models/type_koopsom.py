...
class TypeKoopsom(object):
    ...
    def __init__(self, koopsom=None, koopjaar=None, indicatie_met_meer_objecten_verkregen=None):  # noqa: E501
        """TypeKoopsom - a model defined in Swagger"""  # noqa: E501
        self._koopsom = None
        self._koopjaar = None
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(TypeKoopsom, dict):
