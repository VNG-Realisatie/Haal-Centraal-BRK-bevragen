...
class ZakelijkGerechtigde(object):
    ...
    def __init__(self, identificatie=None, type=None, aanvangsdatum=None, erfpacht_canon=None, tenaamstelling=None, persoon=None):  # noqa: E501
        """ZakelijkGerechtigde - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ZakelijkGerechtigde, dict):
