...
class ZakelijkGerechtigdeLinks(object):
    ...
    def __init__(self, _self=None, persoon=None, betrokken_partner=None, betrokken_samenwerkingsverband=None, betrokken_gorzen_en_aanwassen=None):  # noqa: E501
        """ZakelijkGerechtigdeLinks - a model defined in Swagger"""  # noqa: E501
        self.__self = None
        self._persoon = None
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ZakelijkGerechtigdeLinks, dict):
